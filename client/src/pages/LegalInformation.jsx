...
export default function LegalInformation() {
    return (
        <main className="min-h-screen bg-[#fff8f2] px-4 pb-16 pt-36 lg:pt-44">
            <div className="mx-auto max-w-5xl">
                ...
                <div className="mt-6 grid gap-5">
                    ...
                    <LegalSection title="2. Purpose of Collection and Use">
                        <p>
                    ...
                    <LegalSection title="3. Protected Cloud Storage">
                        <p>
                    ...
                    <LegalSection title="4. Consent and User Choice">
                        <p>
                    ...
                    <LegalSection title="5. Photo Visibility Consent">
                        <p>
                    ...
                    <LegalSection title="6. Profile Approval, Rejection, and Deactivation">
                        <p>
                    ...
                    <LegalSection title="7. Data Retention and Deletion Requests">
                        <p>
                    ...
                    <LegalSection title="9. Sharing and Disclosure">
                        <p>
                    ...
                    <LegalSection title="10. Grievance and Support Contact">
                        <p>
                    ...
                    <LegalSection title="11. Legal and Regulatory References">
                        <p>
                    ...
                    <LegalSection title="12. Summary Acknowledgement">
                        <p>
